...
class NutriverifController extends AbstractController
{
    ...
    public function searchDish(Request $request, HttpClientInterface $httpClient): JsonResponse
    {
        ...
        $apiProduct = [
            ...
            'nutriments' => [
                'energy-kcal_serving' => (string) ($dishData['energy-kcal_serving'] ?? '0'),
                'carbohydrates_serving' => (string) ($dishData['carbohydrates_serving'] ?? '0'),
                'sugars_serving' => (string) ($dishData['sugars_serving'] ?? '0'),
                'fat_serving' => (string) ($dishData['fat_serving'] ?? '0'),
                'saturated-fat_serving' => (string) ($dishData['saturated-fat_serving'] ?? '0'),
                'fiber_serving' => (string) ($dishData['fiber_serving'] ?? '0'),
                'proteins_serving' => (string) ($dishData['proteins_serving'] ?? '0'),
                'salt_serving' => (string) ($dishData['salt_serving'] ?? '0'),
            ],
