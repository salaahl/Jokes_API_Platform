...
class NutriverifController extends AbstractController
{
    ...
    public function searchDish(Request $request, HttpClientInterface $httpClient): JsonResponse
    {
            ...
            'generationConfig' => [
                ...
                'response_schema' => [
                    ...
                    'properties' => [
                        ...
                        'energy-kcal_serving' => ['type' => 'NUMBER'],
                        'carbohydrates_serving' => ['type' => 'NUMBER'],
                        'sugars_serving' => ['type' => 'NUMBER'],
                        'fat_serving' => ['type' => 'NUMBER'],
                        'saturated-fat_serving' => ['type' => 'NUMBER'],
        ...
        $apiProduct = [
            ...
            'nutriments' => [
                'energy-kcal_serving' => (float) ($dishData['energy-kcal_serving'] ?? 0),
                'carbohydrates_serving' => (float) ($dishData['carbohydrates_serving'] ?? 0),
                'sugars_serving' => (float) ($dishData['sugars_serving'] ?? 0),
                'fat_serving' => (float) ($dishData['fat_serving'] ?? 0),
                'saturated-fat_serving' => (float) ($dishData['saturated-fat_serving'] ?? 0),
                'fiber_serving' => (float) ($dishData['fiber_serving'] ?? 0),
                'proteins_serving' => (float) ($dishData['proteins_serving'] ?? 0),
                'salt_serving' => (float) ($dishData['salt_serving'] ?? 0),
            ],
